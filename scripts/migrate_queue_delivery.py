...
# When invoked as ``python scripts/migrate_queue_delivery.py`` Python puts the
# scripts directory on sys.path, not the repository root.  Add the root so the
# operator command works from a clean checkout as documented.
