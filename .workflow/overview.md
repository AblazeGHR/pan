...
- `main`：`ea3fcd7`（2026-09-15 核对，T-038 收束文档与合入后独立复跑已完成）；T-025 文件输入与结构化附件协议已合入并完成归档；T-027.1 / T-027.2 已合入、待开发者验收；T-035 已合入、待开发者验收；T-037/T-038 已合入、仍待开发者验收；**未 push**。
